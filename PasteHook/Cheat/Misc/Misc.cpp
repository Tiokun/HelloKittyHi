...
void CMisc::OnRenderSpectatorList() // Roshly#7550
{
	if (Settings::Misc::misc_Spectators)
	{
		...
		if(bIsGuiVisible)
		{
			if (ImGui::Begin("Spectators", &Settings::Misc::misc_Spectators, ImVec2(30, 30), .9f, ImGuiWindowFlags_NoScrollbar | 
		...
		{
			if (ImGui::Begin("Spectators", &Settings::Misc::misc_Spectators, ImVec2(30, 30), .0f, ImGuiWindowFlags_NoScrollbar | 
				ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize))
			{
				if (specs> 0) spect += "\n";
				ImVec2 size = ImGui::CalcTextSize(spect.c_str());
		...
		/*if (ImGui::Begin("Spectator List", &Settings::Misc::misc_Spectators, ImVec2(200, 100), .0f, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoCollapse))
		{
			if (specs> 0) spect += "\n";
			if (modes> 0) mode += "\n";
			ImVec2 size = ImGui::CalcTextSize(spect.c_str());
