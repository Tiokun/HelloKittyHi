...
namespace Settings
{
	void LoadSettings( string szIniFile )
	{
		...
		Esp::esp_Defusing = CSX::Cvar::LoadCvar( VISUAL_TEXT , CVAR_ESP_ISDEFUSING , Esp::esp_Defusing );
		...
		Esp::esp_ghelper = CSX::Cvar::LoadCvar( VISUAL_TEXT , CVAR_ESP_GHELPER , Esp::esp_ghelper ) != false;
		...
		Esp::esp_HitMarker = CSX::Cvar::LoadCvar(VISUAL_TEXT, CVAR_ESP_HITMARKER, Esp::esp_HitMarker);
		Esp::esp_HitMarkerSound = CSX::Cvar::LoadCvar(VISUAL_TEXT, CVAR_ESP_HITMARKER_SOUND, Esp::esp_HitMarkerSound);
		string Color_HITMARKER = CSX::Cvar::LoadCvar(VISUAL_TEXT, "esp_HitMarkerColor", "255,255,255");
		...
		for ( DWORD i = 0; i < WEAPON_DATA_SIZE; i++)
		{
			g_SkinChangerCfg[pWeaponItemIndexData[i]].flFallbackWear = CSX::Cvar::LoadCvar(SKIN_TEXT, pWeaponData_wear[i], 0);
		}
		...
		Misc::misc_Rank = CSX::Cvar::LoadCvar(MISC_TEXT, CVAR_MISC_RANKTOGGLE, Misc::misc_ranktoggle);
...
/*		CSX::Cvar::SaveCvar( TRIGGER_TEXT , CVAR_TRIGGER_ENABLE , Triggerbot::trigger_Enable );
		...
		CSX::Cvar::SaveCvar( VISUAL_TEXT , CVAR_ESP_ISDEFUSING , Settings::Esp::esp_Defusing );
		...
		CSX::Cvar::SaveCvar( VISUAL_TEXT , CVAR_ESP_GHELPER , Settings::Esp::esp_ghelper );
		...
		CSX::Cvar::SaveCvar( VISUAL_TEXT , CVAR_ESP_HITMARKER, Settings::Esp::esp_HitMarker);
		CSX::Cvar::SaveCvar( VISUAL_TEXT , CVAR_ESP_HITMARKER_SOUND , Settings::Esp::esp_HitMarkerSound);
		CSX::Cvar::SaveCvar( VISUAL_TEXT , CVAR_ESP_HITMARKER_COLOR, Color_HITMARKER);
		...
		for (DWORD i = 0; i < WEAPON_DATA_SIZE; i++)
		{
			CSX::Cvar::SaveCvar(SKIN_TEXT, pWeaponData_wear[i], g_SkinChangerCfg[pWeaponItemIndexData[i]].flFallbackWear);
		}
		...
		CSX::Cvar::SaveCvar( MISC_TEXT , CVAR_MISC_RANKTOGGLE, Misc::misc_ranktoggle);
	...
	namespace InventoryChanger {
		bool enabled = true; 
		std::vector<uint32_t> medals = {}; // MEDAL IDS
